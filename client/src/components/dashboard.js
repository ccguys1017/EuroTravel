...
let default_saved_itin = [
  {
    _id: "59df8feca979cb0950260bea",
    updatedAt: "2017-10-12T15:53:16.270Z",
    createdAt: "2017-10-12T15:53:16.270Z",
...
*/
  ...
  componentWillMount() {
    const user_email = localStorage.getItem("userEmail");
    axios
      .post(`${ROOT_URL}/get_itin`, { user_email })
      .then(response => {
      ...
      <div>
        ...
        <div className="dashboard">
          ...
          <div className="col-md-6">
            <h4>
              <strong>Your Previously saved Itineraries</strong>
            </h4>
          ...
          <br />
          <h3>
            <strong>Search the World for your New Vacation!</strong>
          </h3>
...
*/
          ...
          <form action="/dashboard" onChange={this.listCities.bind(this)}>
            <div className="col-md-2">
              <h3>
                <strong>or Search Europe:</strong>
              </h3>
          ...
          <div className="col-md-2">
            ...
            <button
              onClick={this.onHotelClick.bind(this)}
            ...
            <button
              onClick={this.findLocation.bind(this)}
              className="btn btn-default"
            >
