...
class Tripresults extends Component {
  ...
  IterateOverPlaces = () => (
    ...
    (
      <PlacesSearch
        ...
        types={["(regions)"]}
        selectedLocation={{
          lat: localStorage.getItem("trip_lat"),
          lng: localStorage.getItem("trip_lng")
        }}
  ...
  createCheckboxes = () => this.props.maps.places.map(this.createCheckbox);
...
export default (Tripresults = connect(mapStateToProps, mapDispatchToProps)(
  Tripresults
));
