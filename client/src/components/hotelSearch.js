...
class hotelSearch extends React.Component {
  ...
  componentDidMount() {
    ...
    function showInfoWindow() {
      var marker = this;
      service.getDetails({ placeId: marker.placeResult.place_id }, function(
        place,
        status
      ) {
    ...
    if (localStorage.getItem("hotel_flag")) {
      if (
        Number(localStorage.getItem("latitude")) != null &&
      ...
      if (
        Number(localStorage.getItem("trip_lat")) != null &&
        localStorage.getItem("trip_lng") != null
      ) {
        var location = {
          lat: Number(localStorage.getItem("trip_lat")),
          lng: Number(localStorage.getItem("trip_lng"))
        };
      } else {
        var location = {
          lat: Number(this.props.state.maps.selectedLocation.lat),
    ...
    return (
      <div className="tripresults">
        ...
        <h3 style={{ textAlign: "center" }}>
          <strong>Nearby Hotels for: </strong>
          <span>
            {cb_city}, {cb_country}
          </span>
        </h3>
